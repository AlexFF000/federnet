...
<template>
    <div class="settings-page">
        <div id="back-arrow-container" class="back-arrow-container">
            <BackArrow ref="backArrowRef" tabindex="1"/>
        </div>
        <div id="interface-settings-section" class="settings-section">
            ...
            <div class="settings-entry">
                ...
                <input type="color" id="primary-background-colour" v-model="primaryBackgroundColour" class="settings-colour-picker" tabindex="2"/>
            </div>

            <div class="settings-entry">
                <label for="secondary-background-colour" class="settings-input-label">Secondary background colour</label>
                <input type="color" id="secondary-background-colour" v-model="secondaryBackgroundColour" class="settings-colour-picker" tabindex="3"/>
            </div>

            <div class="settings-entry">
                <label for="tertiary-background-colour" class="settings-input-label">Tertiary background colour</label>
                <input type="color" id="tertiary-background-colour" v-model="tertiaryBackgroundColour" class="settings-colour-picker" tabindex="4"/>
            </div>

            <div class="settings-entry">
                <label for="primary-button-background-colour" class="settings-input-label">Primary button background colour</label>
                <input type="color" id="primary-button-background-colour" v-model="primaryButtonBackgroundColour" class="settings-colour-picker" tabindex="5"/>
            </div>

            <div class="settings-entry">
                <label for="secondary-button-background-colour" class="settings-input-label">Secondary button background colour</label>
                <input type="color" id="secondary-button-background-colour" v-model="secondaryButtonBackgroundColour" class="settings-colour-picker" tabindex="6"/>
            </div>

            <div class="settings-entry">
                <label for="primary-button-text-colour" class="settings-input-label">Primary button text colour</label>
                <input type="color" id="primary-button-text-colour" v-model="primaryButtonTextColour" class="settings-colour-picker" tabindex="7"/>
            </div>

            <div class="settings-entry">
                <label for="secondary-button-text-colour" class="settings-input-label">Secondary button text colour</label>
                <input type="color" id="secondary-button-text-colour" v-model="secondaryButtonTextColour" class="settings-colour-picker" tabindex="8"/>
            </div>

            <div class="settings-entry">
                <label for="primary-text-colour" class="settings-input-label">Primary text colour</label>
                <input type="color" id="primary-text-colour" v-model="primaryTextColour" class="settings-colour-picker" tabindex="9"/>
            </div>

            <div class="settings-entry">
                <label for="secondary-text-colour" class="settings-input-label">Secondary text colour</label>
                <input type="color" id="secondary-text-colour" v-model="secondaryTextColour" class="settings-colour-picker" tabindex="10"/>
            </div>
        </div>

        <div class="settings-page-buttons">
            <input type="button" id="cancel-button" value="Cancel" class="form-submit-button page-button button-secondary " @click="cancel" tabindex="11"/>
            <input type="button" id="save-button" value="Save" @click="save" class="form-submit-button page-button" tabindex="12"/>
        </div>
    </div>
</template>
